...
def create_campaign_pdf(output_filename="campaign_report.pdf"):
    ...
    main_title_style = ParagraphStyle(
        "MainTitle", parent=styles["Heading1"], fontSize=16, alignment=1, spaceAfter=10
    )

    subtitle_style = ParagraphStyle(
        "SubTitle", parent=styles["Heading2"], fontSize=14, alignment=1, spaceAfter=10
    )
    ...
    sig_data1 = [
        ...
        [
            "Digital Commercial Officer",
            "Digital Commercial Section\nHead",
